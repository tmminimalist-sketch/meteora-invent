...
var VAULT_WITH_NON_PDA_BASED_LP_MINTS = /* @__PURE__ */ new Map([
  [
    ...
    new (0, _web3js.PublicKey)("5CuhvouXVx6t5XPiyhRkrfgK5omAf8XnqY1ef6CLjw7o")
  ],
  [
    "AzrUPWWyT9ZoAuMTgGHxYCnnWD2veh98FsCcMknVjg3Q",
    new (0, _web3js.PublicKey)("9MSsSzDKq8VzokicRom6ciYPLhhZf65bCCBQLjnC7jUH")
  ],
  [
    "GGQfASSnFaqPu83jWrL1DMJBJEzG3rdwsDARDGt6Gxmj",
    new (0, _web3js.PublicKey)("4da9saTYgDs37wRSuS8mnFoiWzSYeRtvSWaFRe8rtkFc")
  ],
  [
    "GofttAxULhp5NE9faWNngsnDM1iJiL75AJ2AkSaaC2CC",
    new (0, _web3js.PublicKey)("Bma9RZx1AjNGcojNJpstGe9Wcytxz17YA6rd2Lq1UirT")
  ],
  [
    "671JaLe2zDgBeXK3UtFHBiid7WFCHAKZTmLqAaQxx7cL",
    new (0, _web3js.PublicKey)("9NywobBSCyntrPSZxEZpUbJXLfgUzKbUF2ZqBBkJLEgB")
  ],
  [
    "2dH3aSpt5aEwhoeSaThKRNtNppEpg2DhGKGa1C5Wecc1",
    new (0, _web3js.PublicKey)("Afe5fiLmbKw7aBi1VgWZb9hEY8nRYtib6LNr5RGUJibP")
  ],
  [
    "BVJACEffKRHvKbQT9VfEqoxrUWJN2UVdonTKYB2c4MgK",
    new (0, _web3js.PublicKey)("FFmYsMk5xQq3zQf1r4A6Yyf3kaKd3LUQokeVa776rKWH")
  ],
  [
    "5XCP3oD3JAuQyDpfBFFVUxsBxNjPQojpKuL4aVhHsDok",
    new (0, _web3js.PublicKey)("EZun6G5514FeqYtUv26cBHWLqXjAEdjGuoX6ThBpBtKj")
  ],
  [
    "mPWBpKzzchEjitz7x4Q2d7cbQ3fHibF2BHWbWk8YGnH",
    new (0, _web3js.PublicKey)("4nCGSVN8ZGuewX36TznzisceaNYzURWPesxyGtDvA2iP")
  ],
  [
    "8p1VKP45hhqq5iZG5fNGoi7ucme8nFLeChoDWNy7rWFm",
    new (0, _web3js.PublicKey)("28KR3goEditLnzBZShRk2H7xvgzc176EoFwMogjdfSkn")
  ],
  [
    "FERjPVNEa7Udq8CEv68h6tPL46Tq7ieE49HrE2wea3XT",
    new (0, _web3js.PublicKey)("FZN7QZ8ZUUAxMPfxYEYkH3cXUASzH8EqA6B4tyCL8f1j")
  ],
  [
    "3ESUFCnRNgZ7Mn2mPPUMmXYaKU8jpnV9VtA17M7t2mHQ",
    new (0, _web3js.PublicKey)("3RpEekjLE5cdcG15YcXJUpxSepemvq2FpmMcgo342BwC")
  ]
]);
...
var getSimulationComputeUnits = async (connection, instructions, payer, lookupTables, commitment = "confirmed") => {
  const testInstructions = [
    ...
    _web3js.ComputeBudgetProgram.setComputeUnitLimit({ units: MAX_COMPUTE_UNITS }),
    ...instructions
  ];
  ...
  if (_optionalChain([rpcResponse, 'optionalAccess', _2 => _2.value, 'optionalAccess', _3 => _3.err])) {
    const logs = _optionalChain([rpcResponse, 'access', _4 => _4.value, 'access', _5 => _5.logs, 'optionalAccess', _6 => _6.join, 'call', _7 => _7("\n  \u2022 ")]) || "No logs available";
    throw new Error(
      `Transaction simulation failed:
  \u2022${logs}` + JSON.stringify(_optionalChain([rpcResponse, 'optionalAccess', _8 => _8.value, 'optionalAccess', _9 => _9.err]))
    );
  }
...
var StakeForFee2 = class _StakeForFee {
  ...
  static async create(connection, pool, opt) {
    const stakeForFeeProgram = createStakeFeeProgram(
      connection,
      _nullishCoalesce(_optionalChain([opt, 'optionalAccess', _10 => _10.stakeForFeeProgramId]), () => ( STAKE_FOR_FEE_PROGRAM_ID))
    );
    const dynamicVaultProgram = createDynamicVaultProgram(
      connection,
      _nullishCoalesce(_optionalChain([opt, 'optionalAccess', _11 => _11.dynamicVaultProgramId]), () => ( DYNAMIC_VAULT_PROGRAM_ID))
    );
  ...
  static async fetchAccountStates(connection, feeVaultKey, topStakerListKey, fullBalanceListKey, pool, opt) {
    const stakeForFeeProgram = createStakeFeeProgram(
      connection,
      _nullishCoalesce(_optionalChain([opt, 'optionalAccess', _13 => _13.stakeForFeeProgramId]), () => ( STAKE_FOR_FEE_PROGRAM_ID))
    );
    const dynamicVaultProgram = createDynamicVaultProgram(
      connection,
      _nullishCoalesce(_optionalChain([opt, 'optionalAccess', _14 => _14.dynamicVaultProgramId]), () => ( DYNAMIC_VAULT_PROGRAM_ID))
    );
    const dynamicAmmProgram = createDynamicAmmProgram(
      connection,
      _nullishCoalesce(_optionalChain([opt, 'optionalAccess', _15 => _15.dynamicAmmProgramId]), () => ( DYNAMIC_AMM_PROGRAM_ID))
    );
    const [
      feeVaultAccount,
  ...
  static async createFeeVault(connection, pool, stakeMint, payer, param, opt) {
    const stakeForFeeProgram = createStakeFeeProgram(
      connection,
      _nullishCoalesce(_optionalChain([opt, 'optionalAccess', _16 => _16.stakeForFeeProgramId]), () => ( STAKE_FOR_FEE_PROGRAM_ID))
    );
    const ammProgram = createDynamicAmmProgram(
      connection,
      _nullishCoalesce(_optionalChain([opt, 'optionalAccess', _17 => _17.dynamicAmmProgramId]), () => ( DYNAMIC_AMM_PROGRAM_ID))
    );
  ...
  static async createFeeVaultWithParams(connection, pool, payer, stakeMint, quoteMint, param, opt) {
    const stakeForFeeProgram = createStakeFeeProgram(
      connection,
      _nullishCoalesce(_optionalChain([opt, 'optionalAccess', _18 => _18.stakeForFeeProgramId]), () => ( STAKE_FOR_FEE_PROGRAM_ID))
    );
    const ammProgram = createDynamicAmmProgram(
      connection,
      _nullishCoalesce(_optionalChain([opt, 'optionalAccess', _19 => _19.dynamicAmmProgramId]), () => ( DYNAMIC_AMM_PROGRAM_ID))
    );
    const feeVaultKey = deriveFeeVault(pool, stakeForFeeProgram.programId);
  ...
  static async createFeeVaultInstructions(connection, pool, payer, stakeMint, quoteMint, param, opt) {
    const stakeForFeeProgram = createStakeFeeProgram(
      connection,
      _nullishCoalesce(_optionalChain([opt, 'optionalAccess', _20 => _20.stakeForFeeProgramId]), () => ( STAKE_FOR_FEE_PROGRAM_ID))
    );
    const ammProgram = createDynamicAmmProgram(
      connection,
      _nullishCoalesce(_optionalChain([opt, 'optionalAccess', _21 => _21.dynamicAmmProgramId]), () => ( DYNAMIC_AMM_PROGRAM_ID))
    );
    const feeVaultKey = deriveFeeVault(pool, stakeForFeeProgram.programId);
    const lpMint = deriveLpMint(pool, ammProgram.programId);
    const topStakerListKey = deriveTopStakerList(
  ...
  static async getAllStakedVaultByUser(connection, owner, opt) {
    ...
    const dynamicAmmProgram = createDynamicAmmProgram(
      connection,
      _nullishCoalesce(_optionalChain([opt, 'optionalAccess', _22 => _22.dynamicAmmProgramId]), () => ( DYNAMIC_AMM_PROGRAM_ID))
    );
    const dynamicVaultProgram = createDynamicVaultProgram(
      connection,
      _nullishCoalesce(_optionalChain([opt, 'optionalAccess', _23 => _23.dynamicVaultProgramId]), () => ( DYNAMIC_VAULT_PROGRAM_ID))
    );
    ...
    const chunkedAccountToFetch = chunks(
      [_web3js.SYSVAR_CLOCK_PUBKEY, ...poolsToFetch, ...lockEscrowToFetch],
      100
    );
    ...
    const poolAccountsToFetch = chunks(
      Array.from(poolAccountsMap.values()).flatMap(
        ({ aVault, aVaultLp, bVault, bVaultLp, lpMint }) => {
          const aVaultLpMint = _nullishCoalesce(VAULT_WITH_NON_PDA_BASED_LP_MINTS.get(aVault.toBase58()), () => ( _web3js.PublicKey.findProgramAddressSync(
            [Buffer.from("lp_mint"), aVault.toBuffer()],
            dynamicVaultProgram.programId
          )[0]));
          const bVaultLpMint = _nullishCoalesce(VAULT_WITH_NON_PDA_BASED_LP_MINTS.get(bVault.toBase58()), () => ( _web3js.PublicKey.findProgramAddressSync(
    ...
    for (let i = 0; i < poolLpAccounts.length; i += 7) {
      ...
      const aVaultLp = _spltoken.AccountLayout.decode(
        new Uint8Array(aVaultLpAccountBuffer.data)
      );
      const bVaultLp = _spltoken.AccountLayout.decode(
        new Uint8Array(bVaultLpAccountBuffer.data)
      );
      const poolLpMint = _spltoken.MintLayout.decode(
        new Uint8Array(lpMintAccountBuffer.data)
      );
      const aVaultLpMint = _spltoken.MintLayout.decode(
        new Uint8Array(aVaultLpMintAccountBuffer.data)
      );
      const bVaultLpMint = _spltoken.MintLayout.decode(
