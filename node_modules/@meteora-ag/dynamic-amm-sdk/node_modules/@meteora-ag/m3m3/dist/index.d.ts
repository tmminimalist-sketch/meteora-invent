...
declare class StakeForFee {
     ...
     */
    static getAllStakedVaultByUser(connection: Connection, owner: PublicKey, opt?: {
        stakeForFeeProgramId?: PublicKey;
        dynamicAmmProgramId?: PublicKey;
        dynamicVaultProgramId?: PublicKey;
    }): Promise<{
     ...
     */
    static getFarmPendingClaimFees({ feeVault, clock, lockEscrow, aVault, bVault, aVaultLp, bVaultLp, aVaultLpMint, bVaultLpMint, poolLpMint, }: {
        feeVault: FeeVault;
        clock: Clock;
        lockEscrow: LockEscrow;
        aVault: DynamicVault;
     ...
     */
    static getFarmReleasedFees({ feeVault, clock, lockEscrow, aVault, bVault, aVaultLp, bVaultLp, aVaultLpMint, bVaultLpMint, poolLpMint, }: {
        feeVault: FeeVault;
        clock: Clock;
        lockEscrow: LockEscrow;
        aVault: DynamicVault;
...
declare const MAX_COMPUTE_UNITS = 1400000;
...
declare const VAULT_WITH_NON_PDA_BASED_LP_MINTS: Map<string, PublicKey>;
