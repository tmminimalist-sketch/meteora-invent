...
import { getAmountByShare, calculateWithdrawableAmount, getUnmintAmount, IDL as VaultIDL, PROGRAM_ID as VAULT_PROGRAM_ID, } from '@meteora-ag/vault-sdk';
...
export const unwrapSOLInstruction = (owner, receiver) => __awaiter(void 0, void 0, void 0, function* () {
    const wSolATAAccount = yield getAssociatedTokenAccount(NATIVE_MINT, owner);
    if (wSolATAAccount) {
        const closedWrappedSolInstruction = createCloseAccountInstruction(wSolATAAccount, receiver ? receiver : owner, owner, []);
...
export function derivePoolAddress(connection, tokenA, tokenB, tokenADecimal, tokenBDecimal, isStable, tradeFeeBps, opt) {
    const { ammProgram } = createProgram(connection, opt === null || opt === void 0 ? void 0 : opt.programId);
 ...
 */
export function checkPoolExists(connection, mintA, mintB, mintADecimal, mintBDecimal, isStable, tradeFeeBps, opt) {
    return __awaiter(this, void 0, void 0, function* () {
        const { ammProgram } = createProgram(connection, opt === null || opt === void 0 ? void 0 : opt.programId);
...
export function generateCurveType(mintADecimal, mintBDecimal, isStable) {
    return isStable
        ? {
            stable: {
