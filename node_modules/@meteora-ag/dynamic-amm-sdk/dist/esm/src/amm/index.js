...
import { AccountLayout, ASSOCIATED_TOKEN_PROGRAM_ID, createMintToInstruction, createSetAuthorityInstruction, MintLayout, NATIVE_MINT, TOKEN_PROGRAM_ID, getMint, getAssociatedTokenAddressSync, } from '@solana/spl-token';
...
export default class AmmImpl {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (feeWrapperLockAmount.gt(new BN(0))) {
                ...
                const createFeeVaultIxs = yield StakeForFee.createFeeVaultInstructions(connection, poolPubkey, payer, tokenAMint, tokenBMint, {
                    unstakeLockDuration: ((_b = opt === null || opt === void 0 ? void 0 : opt.stakeLiquidity) === null || _b === void 0 ? void 0 : _b.param.unstakeLockDuration) || new BN(0),
                    secondsToFullUnlock: ((_c = opt === null || opt === void 0 ? void 0 : opt.stakeLiquidity) === null || _c === void 0 ? void 0 : _c.param.secondsToFullUnlock) || new BN(0),
                    topListLength: ((_d = opt === null || opt === void 0 ? void 0 : opt.stakeLiquidity) === null || _d === void 0 ? void 0 : _d.param.topListLength) || 0,
                    startFeeDistributeTimestamp: ((_e = opt === null || opt === void 0 ? void 0 : opt.stakeLiquidity) === null || _e === void 0 ? void 0 : _e.param.startFeeDistributeTimestamp) || new BN(0),
    ...
    static createPermissionlessPool(connection, payer, mintA, mintB, tokenAAmount, tokenBAmount, isStable, tradeFeeBps, opt) {
        return __awaiter(this, void 0, void 0, function* () {
            const { vaultProgram, ammProgram } = createProgram(connection, opt === null || opt === void 0 ? void 0 : opt.programId);
            const [tokenMintA, tokenMintB] = yield Promise.all([mintA, mintB].map((m) => getMint(connection, m)));
            const curveType = generateCurveType(tokenMintA.decimals, tokenMintB.decimals, isStable);
            const [{ vaultPda: aVault, tokenVaultPda: aTokenVault, lpMintPda: aLpMintPda }, { vaultPda: bVault, tokenVaultPda: bTokenVault, lpMintPda: bLpMintPda },] = [getVaultPdas(mintA, vaultProgram.programId), getVaultPdas(mintB, vaultProgram.programId)];
            const [aVaultAccount, bVaultAccount] = yield Promise.all([
                vaultProgram.account.vault.fetchNullable(aVault),
                vaultProgram.account.vault.fetchNullable(bVault),
            ]);
            ...
            if (!aVaultAccount) {
                const createVaultAIx = yield VaultImpl.createPermissionlessVaultInstruction(connection, payer, mintA);
                createVaultAIx && preInstructions.push(createVaultAIx);
            }
            else {
                aVaultLpMint = aVaultAccount.lpMint; // Old vault doesn't have lp mint pda
            ...
            if (!bVaultAccount) {
                const createVaultBIx = yield VaultImpl.createPermissionlessVaultInstruction(connection, payer, mintB);
                createVaultBIx && preInstructions.push(createVaultBIx);
            }
            else {
                bVaultLpMint = bVaultAccount.lpMint; // Old vault doesn't have lp mint pda
            }
            const poolPubkey = derivePoolAddress(connection, tokenMintA.address, tokenMintB.address, tokenMintA.decimals, tokenMintB.decimals, isStable, tradeFeeBps, {
            ...
            createPayerTokenBIx && preInstructions.push(createPayerTokenBIx);
            const [[protocolTokenAFee], [protocolTokenBFee]] = [
                PublicKey.findProgramAddressSync([Buffer.from(SEEDS.FEE), mintA.toBuffer(), poolPubkey.toBuffer()], ammProgram.programId),
                PublicKey.findProgramAddressSync([Buffer.from(SEEDS.FEE), mintB.toBuffer(), poolPubkey.toBuffer()], ammProgram.programId),
            ];
            const [lpMint] = PublicKey.findProgramAddressSync([Buffer.from(SEEDS.LP_MINT), poolPubkey.toBuffer()], ammProgram.programId);
            const payerPoolLp = yield getAssociatedTokenAccount(lpMint, payer);
    ...
    swap(owner, inTokenMint, inAmountLamport, outAmountLamport, referralOwner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (NATIVE_MINT.equals(destinationToken)) {
                const unwrapSOLIx = yield unwrapSOLInstruction(owner, owner);
     ...
     * @returns A transaction object
     */
    swapAndStakeForFee(owner, inTokenMint, inAmountLamport, minOutAmountLamport, outAmountLamport, stakeForFee) {
        return __awaiter(this, void 0, void 0, function* () {
            const resultTxs = [];
            const swapTx = yield this.swap(owner, inTokenMint, inAmountLamport, minOutAmountLamport);
            resultTxs.push(swapTx);
            const stakeTx = yield stakeForFee.stake(outAmountLamport, owner);
    ...
    deposit(owner, tokenAInAmount, tokenBInAmount, poolTokenAmount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ([this.tokenAMint.address.toBase58(), this.tokenBMint.address.toBase58()].includes(NATIVE_MINT.toBase58())) {
                const closeWrappedSOLIx = yield unwrapSOLInstruction(owner, owner);
     ...
     * @returns A transaction object
     */
    lockLiquidity(owner, amount, feePayer, opt) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            ...
            const { userLockAmount, feeWrapperLockAmount } = calculateLockAmounts(amount, (_a = opt === null || opt === void 0 ? void 0 : opt.stakeLiquidity) === null || _a === void 0 ? void 0 : _a.ratio);
            if (feeWrapperLockAmount.gt(new BN(0))) {
                ...
                const vaultState = yield getFeeVaultState(vaultKey, stakeForFeeProgram);
                if (!vaultState) {
                ...
                const [escrowFeeVaultAta, createEscrowFeeVaultAtaIx] = yield getOrCreateATAInstruction(this.poolState.lpMint, lockEscrowFeeVaultPK, this.program.provider.connection, payer);
            ...
            const transaction = new Transaction(Object.assign({ feePayer: payer }, (yield this.program.provider.connection.getLatestBlockhash(this.program.provider.connection.commitment))));
    ...
    claimWithQuoteMintSol(_a) {
        return __awaiter(this, arguments, void 0, function* ({ owner, payer, receiver, tempWSolAcc, lockEscrowPK, }) {
            const preInstructions = [];
            const postInstructions = [];
            ...
            const [[userAta, createUserAtaIx], [escrowAta, createEscrowAtaIx], [tokenAAta, createTokenAAtaIx], [tokenBAta, createTokenBAtaIx],] = yield Promise.all([
                ...
                getOrCreateATAInstruction(this.poolState.lpMint, lockEscrowPK, this.program.provider.connection, payer),
                getOrCreateATAInstruction(this.poolState.tokenAMint, isTokenAMintNative ? tempWSolAcc : receiver, this.program.provider.connection, payer),
                getOrCreateATAInstruction(this.poolState.tokenBMint, isTokenBMintNative ? tempWSolAcc : receiver, this.program.provider.connection, payer),
            ]);
            createUserAtaIx && preInstructions.push(createUserAtaIx);
            createEscrowAtaIx && preInstructions.push(createEscrowAtaIx);
            createTokenAAtaIx && preInstructions.push(createTokenAAtaIx);
            createTokenBAtaIx && preInstructions.push(createTokenBAtaIx);
            const closeWrappedSOLIx = yield unwrapSOLInstruction(tempWSolAcc, receiver);
            closeWrappedSOLIx && postInstructions.push(closeWrappedSOLIx);
            const accounts = {
                pool: this.address,
                lockEscrow: lockEscrowPK,
    ...
    claimWithQuoteMintNotSol(_a) {
        return __awaiter(this, arguments, void 0, function* ({ owner, payer, receiver, lockEscrowPK, }) {
            const preInstructions = [];
            const [[userAta, createUserAtaIx], [escrowAta, createEscrowAtaIx], [tokenAAta, createTokenAAtaIx], [tokenBAta, createTokenBAtaIx],] = yield Promise.all([
                getOrCreateATAInstruction(this.poolState.lpMint, owner, this.program.provider.connection, payer),
                getOrCreateATAInstruction(this.poolState.lpMint, lockEscrowPK, this.program.provider.connection, payer),
    ...
    claimLockFee(owner, maxAmount, payer, receiver, tempWSolAcc) {
        return __awaiter(this, void 0, void 0, function* () {
            const [lockEscrowPK] = deriveLockEscrowPda(this.address, owner, this.program.programId);
            const isTokenAOrBNative = this.poolState.tokenAMint.toBase58() === NATIVE_MINT.toBase58() ||
            ...
            if (isTokenAOrBNative) {
                ...
                const result = yield this.claimWithQuoteMintSol({
                    owner,
                    payer,
                ...
                const feeReceiver = receiver ? receiver : owner;
                const result = yield this.claimWithQuoteMintNotSol({
                    owner,
                    payer,
                    receiver: feeReceiver,
                    lockEscrowPK,
            ...
            return new Transaction(Object.assign({ feePayer: payer }, (yield this.program.provider.connection.getLatestBlockhash(this.program.provider.connection.commitment)))).add(tx);
        });
    }
    /**
     ...
     */
    moveLockedLP(owner, newOwner, maxAmount, payer) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [toEscrowVault, createToEscrowVaultIx] = yield getOrCreateATAInstruction(this.poolState.lpMint, newOwnerLockEscrowPK, this.program.provider.connection, payer);
            ...
            const tx = yield this.program.methods
                ...
                .preInstructions(preInstructions)
                .transaction();
            const transaction = new Transaction(Object.assign({ feePayer: payer }, (yield this.program.provider.connection.getLatestBlockhash(this.program.provider.connection.commitment)))).add(tx);
            return transaction;
        });
    }
