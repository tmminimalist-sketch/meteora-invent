...
import StakeForFee, { InitializeVaultParams } from '@meteora-ag/m3m3';
...
export default class AmmImpl implements AmmImplementation {
    ...
    static createPermissionlessPool(connection: Connection, payer: PublicKey, mintA: PublicKey, mintB: PublicKey, tokenAAmount: BN, tokenBAmount: BN, isStable: boolean, tradeFeeBps: BN, opt?: {
        programId?: string;
        skipAta?: boolean;
    }): Promise<Transaction>;
    ...
    claimLockFee(owner: PublicKey, maxAmount: BN, payer: PublicKey, receiver?: PublicKey, tempWSolAcc?: PublicKey): Promise<Transaction>;
    /**
     ...
     */
    moveLockedLP(owner: PublicKey, newOwner: PublicKey, maxAmount: BN, payer?: PublicKey): Promise<Transaction>;
